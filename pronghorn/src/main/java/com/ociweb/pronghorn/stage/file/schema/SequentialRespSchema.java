...
public class SequentialRespSchema extends MessageSchema<SequentialRespSchema> {
	...
	public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
		...
		protected SequentialRespSchema() { 
		    super(FROM);
		}

		public static final SequentialRespSchema instance = new SequentialRespSchema();
		...
		public static void consumeClearAck(Pipe<SequentialRespSchema> input) {
		}
		public static void consumeMetaResponse(Pipe<SequentialRespSchema> input) {
		...
		public static void consumeWriteAck(Pipe<SequentialRespSchema> input) {
		    long fieldId = PipeReader.readLong(input,MSG_WRITEACK_3_FIELD_ID_12);
		}

		public static void publishClearAck(Pipe<SequentialRespSchema> output) {
		        PipeWriter.presumeWriteFragment(output, MSG_CLEARACK_1);
		        PipeWriter.publishWrites(output);
		}
		public static void publishMetaResponse(Pipe<SequentialRespSchema> output, long fieldSize, long fieldDate) {
		...
		public static void publishWriteAck(Pipe<SequentialRespSchema> output, long fieldId) {
