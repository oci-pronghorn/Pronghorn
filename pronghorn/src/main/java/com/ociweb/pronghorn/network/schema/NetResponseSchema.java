...
public class NetResponseSchema extends MessageSchema<NetResponseSchema> {
	...
	public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
		    new int[]{0xc0400004,0x90000000,0x80000000,0xb8000000,0xc0200004,0xc0400004,0x90000000,0x80000000,0xb8000000,0xc0200004,0xc0400005,0x90000000,0x80000001,0xa8000001,0x80000000,0xc0200005},
		    (short)0,
		    new String[]{"Response","ConnectionId","ContextFlags","Payload",null,"Continuation","ConnectionId",
		    "ContextFlags","Payload",null,"Closed","ConnectionId","SessionId","Host","Port",null},
		    new long[]{101, 1, 5, 3, 0, 102, 1, 5, 3, 0, 10, 1, 2, 4, 5, 0},
		...
		public static final int MSG_CLOSED_10 = 0x0000000a; //Group/OpenTempl/5
		public static final int MSG_CLOSED_10_FIELD_CONNECTIONID_1 = 0x00800001; //LongUnsigned/None/0
		public static final int MSG_CLOSED_10_FIELD_SESSIONID_2 = 0x00000003; //IntegerUnsigned/None/1
		public static final int MSG_CLOSED_10_FIELD_HOST_4 = 0x01400004; //UTF8/None/1
		public static final int MSG_CLOSED_10_FIELD_PORT_5 = 0x00000006; //IntegerUnsigned/None/0
