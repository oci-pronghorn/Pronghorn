...
public class HTTPRequestSchema extends MessageSchema<HTTPRequestSchema> {
	...
	protected HTTPRequestSchema(FieldReferenceOffsetManager from) { 
	    super(from);
	}

	public HTTPRequestSchema() { 
	    super(FROM);
	}

	public static final HTTPRequestSchema instance = new HTTPRequestSchema();
