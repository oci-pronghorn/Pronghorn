...
public class PipeDataCopy {
	...
	public void simpleByteCopy() {
		...
		Pipe.copyBytesFromToRing(byteSource, sourceloc, sourceMask, target, targetloc, targetMask, length);
	...
	public void simpleintCopy() {
		...
		Pipe.copyIntsFromToRing(intSource, sourceloc, sourceMask, target, targetloc, targetMask, length);
