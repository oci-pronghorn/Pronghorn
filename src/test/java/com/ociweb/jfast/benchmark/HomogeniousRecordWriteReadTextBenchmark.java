...
public class HomogeniousRecordWriteReadTextBenchmark extends Benchmark {
	...
	static final FASTReaderInterpreterDispatch staticReader = new FASTReaderInterpreterDispatch(dictionaryFactory, 3, new int[0][0], 24, 0, 4, 4, null, 64,8, 7, maxGroupCount * 10, 0);
