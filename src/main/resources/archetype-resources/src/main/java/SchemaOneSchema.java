...
public class SchemaOneSchema extends MessageSchema<SchemaOneSchema> {
	...
	public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
			...
			(short)0,
			new String[]{"SomeKindOfMessage","AnUnsignedInt","AnUnsignedLong","AnArrayOfBytes",null,"SomeOtherMessage",
	...
	public static final int MSG_SOMEKINDOFMessage_1 = 0x00000000; //Group/OpenTempl/4
	public static final int MSG_SOMEKINDOFMessage_1_FIELD_ANUNSIGNEDINT_101 = 0x00000001; //IntegerUnsigned/None/0
	public static final int MSG_SOMEKINDOFMessage_1_FIELD_ANUNSIGNEDLONG_201 = 0x00800002; //LongUnsigned/None/0
	public static final int MSG_SOMEKINDOFMessage_1_FIELD_ANARRAYOFBYTES_301 = 0x01c00004; //ByteVector/None/0
	public static final int MSG_SOMEOTHERMessage_2 = 0x00000005; //Group/OpenTempl/3
	public static final int MSG_SOMEOTHERMessage_2_FIELD_ASIGNEDINT_102 = 0x00400001; //IntegerSigned/None/1
	...
	public static void consumeSomeKindOfMessage(Pipe<SchemaOneSchema> input) {
		int fieldAnUnsignedInt = PipeReader.readInt(input,MSG_SOMEKINDOFMessage_1_FIELD_ANUNSIGNEDINT_101);
	...
	public static void consumeSomeOtherMessage(Pipe<SchemaOneSchema> input) {
		int fieldASignedInt = PipeReader.readInt(input,MSG_SOMEOTHERMessage_2_FIELD_ASIGNEDINT_102);
		long fieldASignedLong = PipeReader.readLong(input,MSG_SOMEOTHERMessage_2_FIELD_ASIGNEDLONG_202);
	}

	public static void publishSomeKindOfMessage(Pipe<SchemaOneSchema> output, int fieldAnUnsignedInt, long fieldAnUnsignedLong, byte[] fieldAnArrayOfBytesBacking, int fieldAnArrayOfBytesPosition, int fieldAnArrayOfBytesLength) {
		PipeWriter.presumeWriteFragment(output, MSG_SOMEKINDOFMessage_1);
		PipeWriter.writeInt(output,MSG_SOMEKINDOFMessage_1_FIELD_ANUNSIGNEDINT_101, fieldAnUnsignedInt);
	...
	public static void publishSomeOtherMessage(Pipe<SchemaOneSchema> output, int fieldASignedInt, long fieldASignedLong) {
		...
		PipeWriter.writeInt(output,MSG_SOMEOTHERMessage_2_FIELD_ASIGNEDINT_102, fieldASignedInt);
