...
public class JPGSchema extends MessageSchema<JPGSchema> {
	...
	public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
	    new int[]{0xc0400004,0x88000000,0x88000001,0xa0000000,0xc0200004,0xc0400005,0x88000002,0x88000003,0x88000004,0x88000005,0xc0200005,0xc0400004,0x88000006,0x88000007,0xb8000001,0xc0200004,0xc0400004,0xb8000002,0xb8000003,0xb8000004,0xc0200004},
	    (short)0,
	    new String[]{"HeaderMessage","height","width","filename",null,"ColorComponentMessage","componentID",
	    "horizontalSamplingFactor","verticalSamplingFactor","quantizationTableID",null,"QuantizationTableMessage",
	    "tableId","precision","table",null,"MCUMessage","y","cb","cr",null},
	    new long[]{1, 101, 201, 301, 0, 2, 102, 202, 302, 402, 0, 3, 103, 203, 303, 0, 4, 104, 204, 304, 0},
	    new String[]{"global",null,null,null,null,"global",null,null,null,null,null,"global",null,null,
	    null,null,"global",null,null,null,null},
	    "JPGSchema.xml",
	    new long[]{2, 2, 0},
	    new int[]{2, 2, 0});
	...
	public static final int MSG_COLORCOMPONENTMESSAGE_2 = 0x00000005; //Group/OpenTempl/5
	public static final int MSG_COLORCOMPONENTMESSAGE_2_FIELD_COMPONENTID_102 = 0x00400001; //IntegerSigned/None/2
	public static final int MSG_COLORCOMPONENTMESSAGE_2_FIELD_HORIZONTALSAMPLINGFACTOR_202 = 0x00400002; //IntegerSigned/None/3
	public static final int MSG_COLORCOMPONENTMESSAGE_2_FIELD_VERTICALSAMPLINGFACTOR_302 = 0x00400003; //IntegerSigned/None/4
	public static final int MSG_COLORCOMPONENTMESSAGE_2_FIELD_QUANTIZATIONTABLEID_402 = 0x00400004; //IntegerSigned/None/5
	public static final int MSG_QUANTIZATIONTABLEMESSAGE_3 = 0x0000000b; //Group/OpenTempl/4
	public static final int MSG_QUANTIZATIONTABLEMESSAGE_3_FIELD_TABLEID_103 = 0x00400001; //IntegerSigned/None/6
	public static final int MSG_QUANTIZATIONTABLEMESSAGE_3_FIELD_PRECISION_203 = 0x00400002; //IntegerSigned/None/7
	public static final int MSG_QUANTIZATIONTABLEMESSAGE_3_FIELD_TABLE_303 = 0x01c00003; //ByteVector/None/1
	public static final int MSG_MCUMESSAGE_4 = 0x00000010; //Group/OpenTempl/4
