...
public class TemplateLoader {
	 ...
	 * 
	 * The jFAST engine will support dynamic template changes among those in the catalog.
	 * Building the catalog also validates no conflicts exist between the contained templates. 
	 * The catalog file can be replaced while jFAST is running however it will not be 
	 * accessed unless an unknown template id is encountered or it is explicitly requested.
	 *
	 * -s -source <folder or XML file as exclusive input into new catalog>
	 * -c -catalog <absolute path to catalog file>
	 * 
	 * @param args
	 */
