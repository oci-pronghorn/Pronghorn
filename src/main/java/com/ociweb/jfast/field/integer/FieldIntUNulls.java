...
public final class FieldIntUNulls extends Field {

	private final int id;
	private final int repeat;
	
	public FieldIntUNulls(int id) {
	...
	public final void reader(PrimitiveReader reader, FASTAccept visitor) {
		if (reader.peekNull()) {
			...
			visitor.accept(id, reader.readUnsignedIntegerNullable());
		}
		//end of reader
	...
	public void writer(PrimitiveWriter writer, FASTProvide provider) {
		if (provider.provideNull(id)) {
		    ...
		    writer.writeUnsignedIntegerNullable(provider.provideInt(id));
		}
		//end of writer
