...
public class ClientConnection extends SSLConnection {
	...
	private final int maxInFlightBits = 10;//12;//TODO: must bump up to get 1M 10;	//only allow x messages in flight at a time.
...
//		}
	...
	//	this.getSocketChannel().setOption(StandardSocketOptions.TCP_NODELAY, true);
		this.getSocketChannel().setOption(StandardSocketOptions.SO_RCVBUF, 1<<19); 
