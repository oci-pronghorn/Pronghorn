...
public class NetPayloadSchema extends MessageSchema {
	...
	public final static FieldReferenceOffsetManager FROM = new FieldReferenceOffsetManager(
		    new int[]{0xc0400003,0x90000000,0xb8000000,0xc0200003,0xc0400004,0x90000000,0x90000001,0xb8000001,0xc0200004,0xc0400002,0x90000000,0xc0200002,0xc0400003,0x90000000,0x80000000,0xc0200003,0xc0400002,0x88000001,0xc0200002},
		    (short)0,
		    new String[]{"Encrypted","ConnectionId","Payload",null,"Plain","ConnectionId","Position","Payload",null,"Disconnect","ConnectionId",null,"Upgrade","ConnectionId","NewRoute",null,"Begin","SequnceNo",null},
		    new long[]{200, 201, 203, 0, 210, 201, 206, 204, 0, 203, 201, 0, 307, 201, 205, 0, 208, 209, 0},
		    new String[]{"global",null,null,null,"global",null,null,null,null,"global",null,null,"global",null,null,null,"global",null,null},
		    "NetPayload.xml",
		    new long[]{2, 2, 0},
		    new int[]{2, 2, 0});
    ...
    public static final int MSG_UPGRADE_307 = 0x0000000c;
    ...
    public static final int MSG_BEGIN_208 = 0x00000010;
