...
public enum HTTPContentTypeDefaults implements HTTPContentType {
    ...
    OGG("audio/vorbis, application/ogg","ogg"),
    ...
    RA("audio/x-pn-realaudio, audio/vnd.rn-realaudio","ra"),
    RAM("audio/x-pn-realaudio, audio/vnd.rn-realaudio","ram"),
    RAS("image/x-cmu-raster","ras"),
    RDF("application/rdf, application/rdf+xml","rdf"),
    ...
    ZIP("application/zip, application/x-compressed-zip","zip");
